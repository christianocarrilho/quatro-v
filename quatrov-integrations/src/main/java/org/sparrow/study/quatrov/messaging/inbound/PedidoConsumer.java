package org.sparrow.study.quatrov.messaging.inbound;
...
public class PedidoConsumer {
    ...
    public void consumirPedido(Pedido pedido) throws InterruptedException {

        LOG.info("=== Novo evento recebido do Kafka ===");
        LOG.info("ID do Pedido: {}", pedido.getId());
        LOG.info("Cliente: {}", pedido.getClienteId());
        LOG.info("Item solicitado: {}", pedido.getItem());
        LOG.info("Valor: R$ {}", pedido.getValor());
        ...
        LOG.info("Pedido {} processado com sucesso! Status atualizado para: APROVADO", pedido.getId());
        System.out.println("=====================================\n");
    }
}